...
public class AuthenticationPromptType extends SchemeValuePair {
    ...
    public AuthenticationPromptType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static AuthenticationPromptType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (AuthenticationPromptType) find(scheme, value, AuthenticationPromptType.class);
    }
