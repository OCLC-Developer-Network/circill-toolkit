...
public class UserUpdatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UserUpdatedResponseData rhs = (UserUpdatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(247024667, 554323301).append(responseHeader).append(problems).toHashCode();
        return result;
    }
