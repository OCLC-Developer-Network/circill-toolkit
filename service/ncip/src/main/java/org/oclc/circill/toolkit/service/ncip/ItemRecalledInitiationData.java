...
public class ItemRecalledInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemRecalledInitiationData rhs = (ItemRecalledInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId).append(userId, rhs.userId)
            .append(itemId, rhs.itemId).append(dateDue, rhs.dateDue).append(shippingInformation, rhs.shippingInformation).append(itemOptionalFields, rhs.itemOptionalFields)
            .append(userOptionalFields, rhs.userOptionalFields).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1872074689, 721326467).append(initiationHeader).append(relyingPartyId).append(userId).append(itemId).append(dateDue)
            .append(shippingInformation).append(itemOptionalFields).append(userOptionalFields).toHashCode();
        return result;
    }
}
