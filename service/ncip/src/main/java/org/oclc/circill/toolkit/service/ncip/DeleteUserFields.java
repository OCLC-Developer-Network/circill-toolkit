...
public class DeleteUserFields {
    ...
    public boolean equals(final Object obj) {
        ...
        final DeleteUserFields rhs = (DeleteUserFields) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1744715439, 191477441).append(authenticationInputs).append(nameInformation).append(userAddressInformations).append(dateOfBirth)
