...
public class FiscalTransactionReferenceId {
    ...
    public boolean equals(final Object obj) {
        ...
        final FiscalTransactionReferenceId rhs = (FiscalTransactionReferenceId) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1140981447, 232255329).append(agencyId).append(fiscalTransactionIdentifierValue).toHashCode();
        return result;
    }
