...
public class Version1ComponentIdentifierType extends ComponentIdentifierType {
    ...
    public static final Version1ComponentIdentifierType BICI = new Version1ComponentIdentifierType(VERSION_1_COMPONENT_IDENTIFIER_TYPE, "BICI");
    public static final Version1ComponentIdentifierType SICI = new Version1ComponentIdentifierType(VERSION_1_COMPONENT_IDENTIFIER_TYPE, "SICI");
    ...
    public Version1ComponentIdentifierType(final String scheme, final String value) {
        super(scheme, value);
    }
}
