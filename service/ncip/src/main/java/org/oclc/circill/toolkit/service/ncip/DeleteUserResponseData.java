...
public class DeleteUserResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final DeleteUserResponseData rhs = (DeleteUserResponseData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1255745517, 1994663559).append(responseHeader).append(problems).append(userId).toHashCode();
        return result;
    }
}
