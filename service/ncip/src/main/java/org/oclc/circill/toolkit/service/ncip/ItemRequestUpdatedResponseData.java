...
public class ItemRequestUpdatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemRequestUpdatedResponseData rhs = (ItemRequestUpdatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(658739579, 187389481).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
