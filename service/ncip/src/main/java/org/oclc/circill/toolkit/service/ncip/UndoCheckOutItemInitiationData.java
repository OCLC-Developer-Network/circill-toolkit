...
public class UndoCheckOutItemInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UndoCheckOutItemInitiationData rhs = (UndoCheckOutItemInitiationData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(876873043, 81726855).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(itemId).append(userId)
            .append(authenticationInputs).append(requestId).toHashCode();
        return result;
    }
}
