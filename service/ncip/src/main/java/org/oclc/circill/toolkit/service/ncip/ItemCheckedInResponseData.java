...
public class ItemCheckedInResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemCheckedInResponseData rhs = (ItemCheckedInResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(2142045089, 1984605911).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
