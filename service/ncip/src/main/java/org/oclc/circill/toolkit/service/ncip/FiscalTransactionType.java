...
public class FiscalTransactionType extends SchemeValuePair {
    ...
    public FiscalTransactionType(final String scheme, final String value) {
        super(scheme, value);
    }

    public FiscalTransactionType(final String value) {
        super(value);
    }
     ...
     */
    public static FiscalTransactionType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (FiscalTransactionType) find(scheme, value, FiscalTransactionType.class);
    }
