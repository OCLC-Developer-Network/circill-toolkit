...
public class ItemUpdatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemUpdatedResponseData rhs = (ItemUpdatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(803690305, 1066030279).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
