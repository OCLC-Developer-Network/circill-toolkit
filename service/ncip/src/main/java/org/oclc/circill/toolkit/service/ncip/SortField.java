...
public class SortField extends SchemeValuePair {
    ...
    public SortField(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static SortField find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (SortField) find(scheme, value, SortField.class);
    }
