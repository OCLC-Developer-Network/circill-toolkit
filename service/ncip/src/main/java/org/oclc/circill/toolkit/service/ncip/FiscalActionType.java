...
public class FiscalActionType extends SchemeValuePair {
    ...
    public FiscalActionType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static FiscalActionType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (FiscalActionType) find(scheme, value, FiscalActionType.class);
    }
