...
public class ReportCirculationStatusChangeInitiationData implements NCIPInitiationData {
     ...
     *
     * @return whether the item was reported lost or not
     */
     ...
     *
     * @return whether the item was reported missing or not
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final ReportCirculationStatusChangeInitiationData rhs = (ReportCirculationStatusChangeInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            .append(mandatedAction, rhs.mandatedAction).append(itemId, rhs.itemId).append(userId, rhs.userId).append(authenticationInputs, rhs.authenticationInputs)
            .append(itemReportedReturned, rhs.itemReportedReturned).append(itemReportedNeverBorrowed, rhs.itemReportedNeverBorrowed).append(itemReportedLost, rhs.itemReportedLost)
            .append(itemReportedMissing, rhs.itemReportedMissing).append(bibliographicDescriptionDesired, rhs.bibliographicDescriptionDesired)
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(973434945, 211125939).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(itemId).append(userId)
            .append(authenticationInputs).append(itemReportedReturned).append(itemReportedNeverBorrowed).append(itemReportedLost).append(itemReportedMissing)
