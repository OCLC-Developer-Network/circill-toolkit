...
public class AddAgencyFields {
     ...
     *
     * @param organizationNameInformations the list of {@link OrganizationNameInformation}
     */
     ...
     *
     * @param agencyAddressInformations the list of {@link AgencyAddressInformation}
     */
     ...
     *
     * @param authenticationPrompts the list of {@link AuthenticationPrompt}
     */
     ...
     *
     * @param applicationProfileSupportedTypes the list of {@link ApplicationProfileSupportedType}
     */
     ...
     *
     * @param consortiumAgreements the list of {@link ConsortiumAgreement}
     */
     ...
     *
     * @param agencyUserPrivilegeTypes the list of {@link AgencyUserPrivilegeType}
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final AddAgencyFields rhs = (AddAgencyFields) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1687339833, 895637503).append(organizationNameInformations).append(agencyAddressInformations).append(authenticationPrompts)
