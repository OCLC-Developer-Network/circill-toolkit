...
public class RecallItemInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final RecallItemInitiationData rhs = (RecallItemInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            .append(mandatedAction, rhs.mandatedAction).append(itemId, rhs.itemId).append(desiredDateDue, rhs.desiredDateDue).append(shippingInformation, rhs.shippingInformation)
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(63272789, 904488203).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(itemId)
            .append(desiredDateDue).append(shippingInformation).append(bibliographicDescriptionDesired).append(circulationStatusDesired).append(electronicResourceDesired)
