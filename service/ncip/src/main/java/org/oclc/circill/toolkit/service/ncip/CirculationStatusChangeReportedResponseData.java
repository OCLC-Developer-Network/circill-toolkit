...
public class CirculationStatusChangeReportedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final CirculationStatusChangeReportedResponseData rhs = (CirculationStatusChangeReportedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(391297093, 1175582677).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
