...
public class UpdateItemResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UpdateItemResponseData rhs = (UpdateItemResponseData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1582209955, 1398070133).append(responseHeader).append(problems).append(itemId).toHashCode();
        return result;
    }
}
