...
public class AgencyCreatedInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final AgencyCreatedInitiationData rhs = (AgencyCreatedInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            .append(agencyId, rhs.agencyId).append(organizationNameInformations, rhs.organizationNameInformations).append(agencyAddressInformations, rhs.agencyAddressInformations)
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(2133176635, 1738001861).append(initiationHeader).append(relyingPartyId).append(agencyId)
