...
public class ComponentIdentifierType extends SchemeValuePair {
    ...
    public ComponentIdentifierType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static ComponentIdentifierType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (ComponentIdentifierType) find(scheme, value, ComponentIdentifierType.class);
    }
