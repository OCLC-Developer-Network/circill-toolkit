...
public class CheckInItemInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final CheckInItemInitiationData rhs = (CheckInItemInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(mandatedAction, rhs.mandatedAction).append(itemId, rhs.itemId)
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(539979803, 1636084381).append(initiationHeader).append(mandatedAction).append(itemId).append(relyingPartyId)
