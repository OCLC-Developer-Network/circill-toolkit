...
public class UserLanguage extends SchemeValuePair {
    ...
    public UserLanguage(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static UserLanguage find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (UserLanguage) find(scheme, value, UserLanguage.class);
    }
