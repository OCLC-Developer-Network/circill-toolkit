...
public class CreateItemResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final CreateItemResponseData rhs = (CreateItemResponseData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(916459791, 642272759).append(responseHeader).append(problems).append(itemId).toHashCode();
        return result;
    }
}
