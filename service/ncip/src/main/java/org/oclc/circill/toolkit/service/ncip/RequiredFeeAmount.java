...
public class RequiredFeeAmount {
    ...
    public boolean equals(final Object obj) {
        ...
        final RequiredFeeAmount rhs = (RequiredFeeAmount) obj;
        return new EqualsBuilder().append(currencyCode, rhs.currencyCode).append(monetaryValue, rhs.monetaryValue).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(79365609, 1026134141).append(currencyCode).append(monetaryValue).toHashCode();
        return result;
    }
