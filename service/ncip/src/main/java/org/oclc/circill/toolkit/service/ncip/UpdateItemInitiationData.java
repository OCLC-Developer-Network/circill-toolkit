...
public class UpdateItemInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UpdateItemInitiationData rhs = (UpdateItemInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            .append(mandatedAction, rhs.mandatedAction).append(itemId, rhs.itemId).append(deleteItemFields, rhs.deleteItemFields).append(addItemFields, rhs.addItemFields)
            .isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(640945185, 1365399879).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(itemId)
            .append(deleteItemFields).append(addItemFields).toHashCode();
        return result;
    }
}
