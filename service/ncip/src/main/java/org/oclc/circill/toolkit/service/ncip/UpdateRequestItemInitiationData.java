...
public class UpdateRequestItemInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UpdateRequestItemInitiationData rhs = (UpdateRequestItemInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            ...
            .append(requestType, rhs.requestType).append(requestId, rhs.requestId).append(deleteRequestFields, rhs.deleteRequestFields)
            .append(addRequestFields, rhs.addRequestFields).append(bibliographicDescriptionDesired, rhs.bibliographicDescriptionDesired)
    ...
    public int hashCode() {
        final int result = new HashCodeBuilder(1582209955, 1398070133).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(userId)
            .append(authenticationInputs).append(itemId).append(requestType).append(requestId).append(deleteRequestFields).append(addRequestFields)
