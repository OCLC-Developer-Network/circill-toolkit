...
public class ItemCreatedInitiationData implements NCIPInitiationData {
     ...
     *
     * @return whether the item is sensitized
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemCreatedInitiationData rhs = (ItemCreatedInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId).append(itemId, rhs.itemId)
            .append(requestId, rhs.requestId).append(bibliographicDescription, rhs.bibliographicDescription).append(itemUseRestrictionTypes, rhs.itemUseRestrictionTypes)
            .append(circulationStatus, rhs.circulationStatus).append(itemDescription, rhs.itemDescription).append(locations, rhs.locations)
            .append(physicalCondition, rhs.physicalCondition).append(securityMarker, rhs.securityMarker).append(sensitizationFlag, rhs.sensitizationFlag).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(2054682227, 2082387183).append(initiationHeader).append(relyingPartyId).append(itemId).append(requestId)
            .append(bibliographicDescription).append(itemUseRestrictionTypes).append(circulationStatus).append(itemDescription).append(locations).append(physicalCondition)
            .append(securityMarker).append(sensitizationFlag).toHashCode();
        return result;
    }
}
