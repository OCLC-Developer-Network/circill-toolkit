 ...
 */
public class RenewAllItemInitiationData implements NCIPInitiationData {
     ...
     * Set DesiredDateDue.
     *
     * @param desiredDateDue the desired due date for the item
     */
     ...
     *
     * @param desiredDateForReturn the desired date-for-return for the item
     */
    public void setDesiredDateForReturn(final GregorianCalendar desiredDateForReturn) {
     ...
     *
     * @return the desired date-for-return for the item
     */
     ...
     *
     * @param acknowledgedItemUseRestrictionTypes the list of acknowledged {@link ItemUseRestrictionType}s
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final RenewAllItemInitiationData rhs = (RenewAllItemInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            .append(mandatedAction, rhs.mandatedAction).append(userId, rhs.userId).append(authenticationInputs, rhs.authenticationInputs).append(desiredDateDue, rhs.desiredDateDue)
            .append(desiredDateForReturn, rhs.desiredDateForReturn).append(acknowledgedFeeAmount, rhs.acknowledgedFeeAmount).append(paidFeeAmount, rhs.paidFeeAmount)
            .append(acknowledgedItemUseRestrictionTypes, rhs.acknowledgedItemUseRestrictionTypes).append(bibliographicDescriptionDesired, rhs.bibliographicDescriptionDesired)
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1698802577, 1833472463).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(userId)
            .append(authenticationInputs).append(desiredDateDue).append(desiredDateForReturn).append(acknowledgedFeeAmount).append(paidFeeAmount)
            .append(acknowledgedItemUseRestrictionTypes).append(bibliographicDescriptionDesired).append(circulationStatusDesired).append(electronicResourceDesired)
            ...
            .append(securityMarkerDesired).append(sensitizationFlagDesired).append(authenticationInputDesired).append(blockOrTrapDesired).append(dateOfBirthDesired)
            .append(nameInformationDesired).append(userAddressInformationDesired).append(userLanguageDesired).append(userPrivilegeDesired).append(userIdDesired)
            .append(previousUserIdDesired).toHashCode();
        return result;
    }
}
