...
public class OrganizationNameType extends SchemeValuePair {
    ...
    public OrganizationNameType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static OrganizationNameType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (OrganizationNameType) find(scheme, value, OrganizationNameType.class);
    }
