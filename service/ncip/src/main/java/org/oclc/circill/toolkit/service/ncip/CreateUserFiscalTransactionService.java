...
public interface CreateUserFiscalTransactionService extends NCIPService<CreateUserFiscalTransactionInitiationData, CreateUserFiscalTransactionResponseData> {
    ...
    @Override
    CreateUserFiscalTransactionResponseData performService(CreateUserFiscalTransactionInitiationData initData,
        ServiceContext<NCIPMessage<CreateUserFiscalTransactionInitiationData, CreateUserFiscalTransactionResponseData>, CreateUserFiscalTransactionInitiationData,
            CreateUserFiscalTransactionResponseData> serviceContext,
