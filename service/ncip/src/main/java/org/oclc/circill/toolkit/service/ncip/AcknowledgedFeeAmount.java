...
public class AcknowledgedFeeAmount {
    ...
    public boolean equals(final Object obj) {
        ...
        final AcknowledgedFeeAmount rhs = (AcknowledgedFeeAmount) obj;
        return new EqualsBuilder().append(currencyCode, rhs.currencyCode).append(monetaryValue, rhs.monetaryValue).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1894718629, 97060167).append(currencyCode).append(monetaryValue).toHashCode();
        return result;
    }
}
