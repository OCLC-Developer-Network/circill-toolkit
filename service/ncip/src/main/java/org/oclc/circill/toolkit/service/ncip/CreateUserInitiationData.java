...
public class CreateUserInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final CreateUserInitiationData rhs = (CreateUserInitiationData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(144811125, 1788434775).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(userId)
            .append(authenticationInputs).append(nameInformation).append(userAddressInformations).append(dateOfBirth).append(userLanguages).append(userPrivileges)
            .append(blockOrTraps).toHashCode();
        return result;
    }
}
