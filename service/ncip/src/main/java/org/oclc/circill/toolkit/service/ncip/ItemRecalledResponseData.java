...
public class ItemRecalledResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemRecalledResponseData rhs = (ItemRecalledResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1036343605, 587037697).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
