...
public class ReportCirculationStatusChangeResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ReportCirculationStatusChangeResponseData rhs = (ReportCirculationStatusChangeResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).append(itemId, rhs.itemId)
            .append(userId, rhs.userId).append(itemOptionalFields, rhs.itemOptionalFields).append(userOptionalFields, rhs.userOptionalFields).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(21246821, 1156381965).append(responseHeader).append(problems).append(itemId).append(userId).append(itemOptionalFields)
