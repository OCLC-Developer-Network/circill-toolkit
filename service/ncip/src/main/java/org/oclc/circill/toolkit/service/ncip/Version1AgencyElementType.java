...
public class Version1AgencyElementType extends AgencyElementType {
    ...
    public static final Version1AgencyElementType APPLICATION_PROFILE_SUPPORTED_TYPE = new Version1AgencyElementType(VERSION_1_AGENCY_ELEMENT_TYPE,
    ...
    public Version1AgencyElementType(final String scheme, final String value) {
        super(scheme, value);
    }
}
