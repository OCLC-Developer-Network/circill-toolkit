...
public class UserIdentifierType extends SchemeValuePair {
    ...
    public UserIdentifierType(final String scheme, final String value) {
        super(scheme, value);
    }

    public UserIdentifierType(final String value) {
        super(value);
    }
     ...
     */
    public static UserIdentifierType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (UserIdentifierType) find(scheme, value, UserIdentifierType.class);
    }
