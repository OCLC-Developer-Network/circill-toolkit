...
public class Version1UnstructuredAddressType extends UnstructuredAddressType {
    ...
    public static final Version1UnstructuredAddressType CARRIAGE_RETURN_NEWLINE_DELIMITED_TEXT = new Version1UnstructuredAddressType(VERSION_1_UNSTRUCTURED_ADDRESS_TYPE,
        "Carriage-Return, Newline-Delimited Text");
    ...
    public Version1UnstructuredAddressType(final String scheme, final String value) {
        super(scheme, value);
    }
