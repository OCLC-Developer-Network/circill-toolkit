...
public class MediumType extends SchemeValuePair {
    ...
    public MediumType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static MediumType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (MediumType) find(scheme, value, MediumType.class);
    }
