...
public class AgencyCreatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final AgencyCreatedResponseData rhs = (AgencyCreatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(2133176635, 1738001861).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
