...
public class RequestIdentifierType extends SchemeValuePair {
    ...
    public RequestIdentifierType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static RequestIdentifierType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (RequestIdentifierType) find(scheme, value, RequestIdentifierType.class);
    }
