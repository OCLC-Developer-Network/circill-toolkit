...
public class ItemRecallCancelledResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemRecallCancelledResponseData rhs = (ItemRecallCancelledResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1872074689, 721326467).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
