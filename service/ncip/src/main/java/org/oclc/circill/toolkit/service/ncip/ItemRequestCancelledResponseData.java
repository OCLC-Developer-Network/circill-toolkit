...
public class ItemRequestCancelledResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final ItemRequestCancelledResponseData rhs = (ItemRequestCancelledResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(433760967, 415055839).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
