...
public class UpdateCirculationStatusInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UpdateCirculationStatusInitiationData rhs = (UpdateCirculationStatusInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            .append(mandatedAction, rhs.mandatedAction).append(itemId, rhs.itemId).append(circulationStatus, rhs.circulationStatus).isEquals();
    }
    ...
    public int hashCode() {
        final int result = new HashCodeBuilder(640945185, 1365399879).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(itemId)
            .append(circulationStatus).toHashCode();
        return result;
    }
}
