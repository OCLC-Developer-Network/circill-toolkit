...
public class ItemElementType extends SchemeValuePair {
    ...
    public ItemElementType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static ItemElementType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (ItemElementType) find(scheme, value, ItemElementType.class);
    }

    public static Iterator<ItemElementType> iterator() {
        return getIterator(ItemElementType.class);
    }
