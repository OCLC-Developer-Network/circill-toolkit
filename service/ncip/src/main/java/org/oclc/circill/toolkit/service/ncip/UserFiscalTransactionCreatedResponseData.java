...
public class UserFiscalTransactionCreatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UserFiscalTransactionCreatedResponseData rhs = (UserFiscalTransactionCreatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(120999981, 324050179).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
