...
public class Version1UserAddressRoleType extends UserAddressRoleType {
    ...
    public static final String VERSION_1_USER_ADDRESS_ROLE_TYPE = "http://www.niso.org/ncip/v2_0/imp1/schemes/useraddressroletype/useraddressroletype.scm";
    ...
    public Version1UserAddressRoleType(final String scheme, final String value) {
        super(scheme, value);
    }
}
