...
public class UndoCheckOutItemResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UndoCheckOutItemResponseData rhs = (UndoCheckOutItemResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).append(itemId, rhs.itemId)
            .append(userId, rhs.userId).append(fiscalTransactionInformation, rhs.fiscalTransactionInformation).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(876873043, 81726855).append(responseHeader).append(problems).append(itemId).append(userId)
            .append(fiscalTransactionInformation).toHashCode();
        return result;
    }
}
