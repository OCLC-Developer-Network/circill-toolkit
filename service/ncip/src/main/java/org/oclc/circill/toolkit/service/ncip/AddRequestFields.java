...
public class AddRequestFields {
    ...
    public boolean equals(final Object obj) {
        ...
        final AddRequestFields rhs = (AddRequestFields) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1687339833, 895637503).append(userId).append(itemId).append(requestType).append(requestScopeType).append(requestStatusType)
