...
public class ItemIdentifierType extends SchemeValuePair {
    ...
    public ItemIdentifierType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static ItemIdentifierType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (ItemIdentifierType) find(scheme, value, ItemIdentifierType.class);
    }
