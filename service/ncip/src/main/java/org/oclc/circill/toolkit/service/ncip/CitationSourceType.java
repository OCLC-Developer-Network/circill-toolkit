...
public class CitationSourceType extends SchemeValuePair {
    ...
    public CitationSourceType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static CitationSourceType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (CitationSourceType) find(scheme, value, CitationSourceType.class);
    }
