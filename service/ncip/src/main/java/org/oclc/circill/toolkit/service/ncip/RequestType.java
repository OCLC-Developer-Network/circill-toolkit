...
public class RequestType extends SchemeValuePair {
    ...
    public RequestType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static RequestType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (RequestType) find(scheme, value, RequestType.class);
    }
