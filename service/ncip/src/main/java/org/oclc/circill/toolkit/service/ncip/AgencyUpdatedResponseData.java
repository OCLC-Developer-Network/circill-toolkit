...
public class AgencyUpdatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final AgencyUpdatedResponseData rhs = (AgencyUpdatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(2113721943, 1616817019).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
