...
public class LookupRequestInitiationData implements NCIPInitiationData {
     ...
     * RequestElementTypes
     */
    protected List<RequestElementType> requestElementTypes;

    /**
     * Set RequestElementTypes.
     *
     * @param requestElementTypes the list of {@link RequestElementType}s
     */
    public void setRequestElementTypes(final List<RequestElementType> requestElementTypes) {
     ...
     *
     * @return a list of {@link RequestElementType}s
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final LookupRequestInitiationData rhs = (LookupRequestInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId).append(userId, rhs.userId)
            .append(authenticationInputs, rhs.authenticationInputs).append(itemId, rhs.itemId).append(requestType, rhs.requestType).append(requestId, rhs.requestId)
            .append(requestElementTypes, rhs.requestElementTypes).append(bibliographicDescriptionDesired, rhs.bibliographicDescriptionDesired)
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(736277271, 748768595).append(initiationHeader).append(relyingPartyId).append(userId).append(authenticationInputs)
            .append(itemId).append(requestType).append(requestId).append(requestElementTypes).append(bibliographicDescriptionDesired).append(circulationStatusDesired)
