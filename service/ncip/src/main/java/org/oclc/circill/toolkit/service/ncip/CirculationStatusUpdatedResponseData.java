...
public class CirculationStatusUpdatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final CirculationStatusUpdatedResponseData rhs = (CirculationStatusUpdatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(185178097, 1936426545).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
