...
public class Language extends SchemeValuePair {
    ...
    public Language(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static Language find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (Language) find(scheme, value, Language.class);
    }
