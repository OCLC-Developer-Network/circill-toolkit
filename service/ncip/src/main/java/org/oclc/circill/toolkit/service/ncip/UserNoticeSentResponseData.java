...
public class UserNoticeSentResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UserNoticeSentResponseData rhs = (UserNoticeSentResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(908340999, 1800095579).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
