...
public interface DeleteItemService extends NCIPService<DeleteItemInitiationData, DeleteItemResponseData> {
    ...
    @Override
    DeleteItemResponseData performService(DeleteItemInitiationData initData,
        ServiceContext<NCIPMessage<DeleteItemInitiationData, DeleteItemResponseData>, DeleteItemInitiationData, DeleteItemResponseData> serviceContext,
