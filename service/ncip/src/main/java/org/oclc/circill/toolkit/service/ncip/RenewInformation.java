...
/**
 * Carries data elements for the results of a renew item operation on a single item.
 */
public class RenewInformation {
     ...
     * Get Problems.
     *
     * @return a list of {@link Problem}s
     */
     ...
     * Set DateDue.
     *
     * @param dateDue the date the item is due
     */
     ...
     * Get DateForReturn.
     *
     * @return the date for return of the item
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final RenewInformation rhs = (RenewInformation) obj;
        return new EqualsBuilder().append(problems, rhs.problems).append(requiredFeeAmount, rhs.requiredFeeAmount)
            .append(requiredItemUseRestrictionTypes, rhs.requiredItemUseRestrictionTypes).append(pending, rhs.pending).append(itemId, rhs.itemId).append(dateDue, rhs.dateDue)
            .append(dateForReturn, rhs.dateForReturn).append(renewalCount, rhs.renewalCount).append(fiscalTransactionInformation, rhs.fiscalTransactionInformation)
            .append(itemOptionalFields, rhs.itemOptionalFields).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(233342589, 469658247).append(problems).append(requiredFeeAmount).append(requiredItemUseRestrictionTypes).append(pending)
            .append(itemId).append(dateDue).append(dateForReturn).append(renewalCount).append(fiscalTransactionInformation).append(itemOptionalFields).toHashCode();
        return result;
    }
}
