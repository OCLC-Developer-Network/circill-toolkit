...
public class AccountBalance {
    ...
    public boolean equals(final Object obj) {
        ...
        final AccountBalance rhs = (AccountBalance) obj;
        return new EqualsBuilder().append(currencyCode, rhs.currencyCode).append(monetaryValue, rhs.monetaryValue).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1821286549, 961179727).append(currencyCode).append(monetaryValue).toHashCode();
        return result;
    }
