...
public class RenewItemInitiationData implements NCIPInitiationData {
     ...
     * Set DesiredDateDue.
     *
     * @param desiredDateDue the date the user wishes the item to be due
     */
     ...
     *
     * @param desiredDateForReturn the desired date for return of the itemx
     */
     ...
     *
     * @return the desired date-for-return
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final RenewItemInitiationData rhs = (RenewItemInitiationData) obj;
        return new EqualsBuilder().append(initiationHeader, rhs.initiationHeader).append(relyingPartyId, rhs.relyingPartyId)
            ...
            .append(desiredDateDue, rhs.desiredDateDue).append(desiredDateForReturn, rhs.desiredDateForReturn).append(acknowledgedFeeAmount, rhs.acknowledgedFeeAmount)
            .append(paidFeeAmount, rhs.paidFeeAmount).append(acknowledgedItemUseRestrictionTypes, rhs.acknowledgedItemUseRestrictionTypes)
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(973434945, 211125939).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(userId)
            .append(authenticationInputs).append(itemId).append(desiredDateDue).append(desiredDateForReturn).append(acknowledgedFeeAmount).append(paidFeeAmount)
