...
public class CreateAgencyResponseData implements NCIPResponseData {
    ...
    /**
     * Problems encountered performing the service.
     */
    ...
    public boolean equals(final Object obj) {
        ...
        final CreateAgencyResponseData rhs = (CreateAgencyResponseData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(185178097, 1936426545).append(responseHeader).append(problems).append(agencyId).toHashCode();
        return result;
    }
}
