...
public class UserCreatedResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final UserCreatedResponseData rhs = (UserCreatedResponseData) obj;
        return new EqualsBuilder().append(responseHeader, rhs.responseHeader).append(problems, rhs.problems).isEquals();
    }

    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1671592897, 1323047669).append(responseHeader).append(problems).toHashCode();
        return result;
    }
}
