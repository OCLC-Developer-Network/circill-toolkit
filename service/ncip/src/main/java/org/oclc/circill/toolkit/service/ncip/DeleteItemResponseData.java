...
public class DeleteItemResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final DeleteItemResponseData rhs = (DeleteItemResponseData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(1744715439, 191477441).append(responseHeader).append(problems).append(itemId).toHashCode();
        return result;
    }
}
