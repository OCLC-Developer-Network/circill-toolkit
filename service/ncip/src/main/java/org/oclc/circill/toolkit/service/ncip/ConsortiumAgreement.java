...
public class ConsortiumAgreement extends SchemeValuePair {
    ...
    public ConsortiumAgreement(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static ConsortiumAgreement find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (ConsortiumAgreement) find(scheme, value, ConsortiumAgreement.class);
    }
