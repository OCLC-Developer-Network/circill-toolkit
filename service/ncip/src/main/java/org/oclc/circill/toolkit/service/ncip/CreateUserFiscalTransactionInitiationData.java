...
public class CreateUserFiscalTransactionInitiationData implements NCIPInitiationData {
    ...
    public boolean equals(final Object obj) {
        ...
        final CreateUserFiscalTransactionInitiationData rhs = (CreateUserFiscalTransactionInitiationData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(916459791, 642272759).append(initiationHeader).append(relyingPartyId).append(mandatedAction).append(userId)
            .append(authenticationInputs).append(fiscalTransactionInformation).toHashCode();
        return result;
    }
}
