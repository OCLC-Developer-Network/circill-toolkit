...
public class CreateUserResponseData implements NCIPResponseData {
    ...
    public boolean equals(final Object obj) {
        ...
        final CreateUserResponseData rhs = (CreateUserResponseData) obj;
    ...
    @Override
    public int hashCode() {
        final int result = new HashCodeBuilder(144811125, 1788434775).append(responseHeader).append(problems).append(userId).toHashCode();
        return result;
    }
}
