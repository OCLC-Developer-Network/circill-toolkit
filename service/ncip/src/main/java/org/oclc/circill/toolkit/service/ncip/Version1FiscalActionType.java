...
public class Version1FiscalActionType extends FiscalActionType {
    ...
    public static final Version1FiscalActionType CANCEL = new Version1FiscalActionType(VERSION_1_FISCAL_ACTION_TYPE, "Cancel");

    public static final Version1FiscalActionType FORGIVE = new Version1FiscalActionType(VERSION_1_FISCAL_ACTION_TYPE, "Forgive");

    public static final Version1FiscalActionType PAYMENT = new Version1FiscalActionType(VERSION_1_FISCAL_ACTION_TYPE, "Payment");
    ...
    public Version1FiscalActionType(final String scheme, final String value) {
        super(scheme, value);
    }
}
