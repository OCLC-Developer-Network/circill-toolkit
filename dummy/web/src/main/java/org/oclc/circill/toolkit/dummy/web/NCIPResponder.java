 ...
 */
@Controller
@RequestMapping("/ncip/responder")
public class NCIPResponder extends ServiceResponder<NCIPMessage<NCIPInitiationData, NCIPResponseData>, NCIPInitiationData, NCIPResponseData> {
    /**
     * Construct an instance.
     */
    public NCIPResponder() {
        super();
    }
