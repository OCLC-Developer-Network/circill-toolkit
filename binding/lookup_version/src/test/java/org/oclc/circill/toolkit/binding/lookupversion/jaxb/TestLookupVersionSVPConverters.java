...
public class TestLookupVersionSVPConverters extends BaseTestSVPConverters {
    ...
    public TestLookupVersionSVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestSVPConverters.instancesToTest(TestLookupVersionSVPConverters.class.getPackage().getName());
    }
}
