...
public class TestILSDIv1_0SVPConverters extends BaseTestSVPConverters {
    ...
    public TestILSDIv1_0SVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestSVPConverters.instancesToTest(TestILSDIv1_0SVPConverters.class.getPackage().getName());
    }
}
