...
package org.oclc.circill.toolkit.binding.ilsdiv1_0.jaxb;
...
public class TestILSDIv1_0JAXBElementSVPConverters extends BaseTestJAXBElementSVPConverters {
    ...
    public TestILSDIv1_0JAXBElementSVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestJAXBElementSVPConverters.instancesToTest(TestILSDIv1_0JAXBElementSVPConverters.class.getPackage().getName());
    }
}
