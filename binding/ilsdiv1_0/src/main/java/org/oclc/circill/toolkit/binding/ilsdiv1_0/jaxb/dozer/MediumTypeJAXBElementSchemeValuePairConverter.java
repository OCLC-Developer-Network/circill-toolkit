...
public class MediumTypeJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<MediumType> {

    public MediumTypeJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, MediumType.class);
    }
