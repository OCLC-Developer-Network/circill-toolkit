...
public class PaymentMethodTypeJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<PaymentMethodType> {

    public PaymentMethodTypeJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, PaymentMethodType.class);
    }
