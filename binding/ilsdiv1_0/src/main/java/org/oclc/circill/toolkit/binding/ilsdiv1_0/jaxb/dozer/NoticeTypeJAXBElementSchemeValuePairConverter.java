...
import org.oclc.circill.toolkit.service.ncip.NoticeType;

public class NoticeTypeJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<NoticeType> {

    public NoticeTypeJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, NoticeType.class);
    }
