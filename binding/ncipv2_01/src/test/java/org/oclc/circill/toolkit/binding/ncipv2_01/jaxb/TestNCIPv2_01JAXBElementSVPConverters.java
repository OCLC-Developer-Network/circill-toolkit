...
public class TestNCIPv2_01JAXBElementSVPConverters extends BaseTestJAXBElementSVPConverters {
    ...
    public TestNCIPv2_01JAXBElementSVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestJAXBElementSVPConverters.instancesToTest(TestNCIPv2_01JAXBElementSVPConverters.class.getPackage().getName());
    }
}
