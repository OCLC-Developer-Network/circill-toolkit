...
public class TestNCIPv2_01SVPConverters extends BaseTestSVPConverters {
    ...
    public TestNCIPv2_01SVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestSVPConverters.instancesToTest(TestNCIPv2_01SVPConverters.class.getPackage().getName());
    }
}
