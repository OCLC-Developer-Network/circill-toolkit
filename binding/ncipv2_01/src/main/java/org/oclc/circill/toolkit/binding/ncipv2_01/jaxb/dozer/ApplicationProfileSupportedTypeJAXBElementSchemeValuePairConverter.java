...
public class ApplicationProfileSupportedTypeJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<ApplicationProfileSupportedType> {

    public ApplicationProfileSupportedTypeJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, ApplicationProfileSupportedType.class);
    }
