...
public class ItemElementTypeJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<ItemElementType> {

    public ItemElementTypeJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, ItemElementType.class);
    }
