...
public class SortFieldSchemeValuePairConverter extends BaseSchemeValuePairConverter<SchemeValuePair, SortField> {

    public SortFieldSchemeValuePairConverter() {
        super(SchemeValuePair.class, SortField.class);
    }
