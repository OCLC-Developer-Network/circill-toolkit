...
public class FiscalActionTypeJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<FiscalActionType> {

    public FiscalActionTypeJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, FiscalActionType.class);
    }
