...
public class RequestScopeTypeJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<RequestScopeType> {

    public RequestScopeTypeJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, RequestScopeType.class);
    }
