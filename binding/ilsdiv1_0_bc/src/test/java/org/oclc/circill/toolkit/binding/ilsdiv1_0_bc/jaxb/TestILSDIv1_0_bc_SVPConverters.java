...
public class TestILSDIv1_0_bc_SVPConverters extends BaseTestSVPConverters {
    ...
    public TestILSDIv1_0_bc_SVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestSVPConverters.instancesToTest(TestILSDIv1_0_bc_SVPConverters.class.getPackage().getName());
    }
}
