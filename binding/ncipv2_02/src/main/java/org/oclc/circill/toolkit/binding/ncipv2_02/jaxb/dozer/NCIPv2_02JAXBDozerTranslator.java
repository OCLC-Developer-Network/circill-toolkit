...
public class NCIPv2_02JAXBDozerTranslator extends
    ...
    @Override
    protected org.oclc.circill.toolkit.binding.ncipv2_02.jaxb.elements.NCIPMessage mapMessage(final NCIPMessage svcMsg) {
        return mapper.map(svcMsg, org.oclc.circill.toolkit.binding.ncipv2_02.jaxb.elements.NCIPMessage.class);
    }

    @Override
    protected NCIPMessage mapMessage(final org.oclc.circill.toolkit.binding.ncipv2_02.jaxb.elements.NCIPMessage svcMsg) {
