...
public class ElementTypeSchemeValuePairConverter extends BaseSchemeValuePairConverter<SchemeValuePair, ElementType> {

    public ElementTypeSchemeValuePairConverter() {
        super(SchemeValuePair.class, ElementType.class);
    }
