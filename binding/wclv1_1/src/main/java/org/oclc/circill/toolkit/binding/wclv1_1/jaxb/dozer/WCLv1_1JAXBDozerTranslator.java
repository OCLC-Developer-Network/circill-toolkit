...
public class WCLv1_1JAXBDozerTranslator extends
    BaseJAXBDozerTranslator<NCIPMessage<NCIPInitiationData, NCIPResponseData>, NCIPInitiationData, NCIPResponseData,
        org.oclc.circill.toolkit.binding.wclv1_1.jaxb.elements.NCIPMessage> {

    /**
     * Default constructor, uses default configuration.
     * @throws ConfigurationException if the Toolkit is not configured properly
     */
    public WCLv1_1JAXBDozerTranslator() throws ConfigurationException {
        super();
    }

    @Override
    protected org.oclc.circill.toolkit.binding.wclv1_1.jaxb.elements.NCIPMessage mapMessage(final NCIPMessage svcMsg) {
        return mapper.map(svcMsg, org.oclc.circill.toolkit.binding.wclv1_1.jaxb.elements.NCIPMessage.class);
    }

    @Override
    protected NCIPMessage mapMessage(final org.oclc.circill.toolkit.binding.wclv1_1.jaxb.elements.NCIPMessage svcMsg) {
