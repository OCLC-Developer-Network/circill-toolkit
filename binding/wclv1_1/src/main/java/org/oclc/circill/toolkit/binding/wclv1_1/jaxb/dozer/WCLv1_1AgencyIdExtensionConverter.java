 ...
 * element in NCIP.
 */
public class WCLv1_1AgencyIdExtensionConverter extends DozerConverter<Ext, AgencyId> implements MapperAware {
     ...
     */
    public WCLv1_1AgencyIdExtensionConverter() {
    ...
    public AgencyId convertTo(final Ext srcExt, AgencyId targetAgencyId) {
        if (srcExt != null) {
            ...
            for (final Object obj : JAXBHelper.getAnyList(srcExt)) {
                // Is it a JAXBElement that matches the field name?
