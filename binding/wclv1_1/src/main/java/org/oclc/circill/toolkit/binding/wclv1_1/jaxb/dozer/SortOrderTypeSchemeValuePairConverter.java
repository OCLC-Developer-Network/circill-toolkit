...
public class SortOrderTypeSchemeValuePairConverter extends BaseSchemeValuePairConverter<SchemeValuePair, SortOrderType> {

    public SortOrderTypeSchemeValuePairConverter() {
        super(SchemeValuePair.class, SortOrderType.class);
    }
