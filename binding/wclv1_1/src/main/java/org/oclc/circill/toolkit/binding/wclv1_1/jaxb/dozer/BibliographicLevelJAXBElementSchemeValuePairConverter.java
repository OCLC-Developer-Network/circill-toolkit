...
public class BibliographicLevelJAXBElementSchemeValuePairConverter extends BaseJAXBElementSchemeValuePairConverter<BibliographicLevel> {

    public BibliographicLevelJAXBElementSchemeValuePairConverter() {
        super(SchemeValuePair.class, BibliographicLevel.class);
    }
