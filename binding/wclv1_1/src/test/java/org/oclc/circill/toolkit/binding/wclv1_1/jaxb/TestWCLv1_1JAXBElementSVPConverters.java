...
package org.oclc.circill.toolkit.binding.wclv1_1.jaxb;
...
public class TestWCLv1_1JAXBElementSVPConverters extends BaseTestJAXBElementSVPConverters {
    ...
    public TestWCLv1_1JAXBElementSVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestJAXBElementSVPConverters.instancesToTest(TestWCLv1_1JAXBElementSVPConverters.class.getPackage().getName());
    }
}
