...
public class TestWCLv1_1SVPConverters extends BaseTestSVPConverters {
    ...
    public TestWCLv1_1SVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestSVPConverters.instancesToTest(TestWCLv1_1SVPConverters.class.getPackage().getName());
    }
}
