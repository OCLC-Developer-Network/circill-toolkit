...
public class TestWCLv1_0JAXBElementSVPConverters extends BaseTestJAXBElementSVPConverters {
    ...
    public TestWCLv1_0JAXBElementSVPConverters(final Class converterClass, final String packageName)
    ...
    public static Collection<Object[]> instancesToTest()
        ...
        return BaseTestJAXBElementSVPConverters.instancesToTest(TestWCLv1_0JAXBElementSVPConverters.class.getPackage().getName());
    }
}
