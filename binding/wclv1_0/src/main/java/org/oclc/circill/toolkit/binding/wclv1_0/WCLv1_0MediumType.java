...
public class WCLv1_0MediumType extends MediumType {
    ...
    public WCLv1_0MediumType(final String scheme, final String value) {
        super(scheme, value);
    }
     ...
     */
    public static WCLv1_0MediumType find(final String scheme, final String value) throws ConfigurationException, ToolkitInternalException {
        return (WCLv1_0MediumType) find(scheme, value, WCLv1_0MediumType.class);
    }
