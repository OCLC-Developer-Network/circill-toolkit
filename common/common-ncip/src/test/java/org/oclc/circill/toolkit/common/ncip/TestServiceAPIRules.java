...
public class TestServiceAPIRules extends BaseTestServiceAPIRules {
    ...
    public void testAll() throws ToolkitInternalException, NoSuchMethodException, IOException, ClassNotFoundException {
        ...
        otherAllowedExceptions.put(DefaultNCIPServiceContextFactory.class.getName(), setApplicationContextMethods);
        otherAllowedExceptions.put(NCIPServiceContextFactory.class.getName(), setApplicationContextMethods);
