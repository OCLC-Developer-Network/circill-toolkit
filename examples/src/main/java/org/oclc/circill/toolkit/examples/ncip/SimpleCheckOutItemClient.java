 ...
 */
public final class SimpleCheckOutItemClient extends SimpleNCIPClient {
    /** The logger. */
    private static final Logger LOG = Logger.getLogger(SimpleCheckOutItemClient.class);
    ...
    public static void main(final String[] args)
        ...
        final SimpleNCIPClient instance = new SimpleCheckOutItemClient();
    ...
    public NCIPInitiationData buildInitiationData(final String[] params) throws ConfigurationException, ToolkitInternalException, ServiceException, ValidationException {
        final CheckOutItemInitiationData checkOutItemData = new CheckOutItemInitiationData();
    ...
    protected void reportSuccess(final NCIPResponseData responseData) {
        final CheckOutItemResponseData checkOutItemResponseData = (CheckOutItemResponseData) responseData;
        LOG.info("Check Out Item succeeded: " + checkOutItemResponseData);
        LOG.info("The due date is: " + DateFormat.getDateInstance().format(checkOutItemResponseData.getDateDue().getTime()));
